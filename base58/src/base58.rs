...
//!
//! This base58 is only for password making.
//! 
//! Based on https://github.com/debris/base58

/// Alphanumeric characters for base58 encoding 
const ALPHABET: &'static [u8] = b"23456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnpqrstuvwxyz*_";
...
/// Errors occur when decoding base58 encoded string.
